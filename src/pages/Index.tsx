  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-blue-50 to-slate-50">
      ...
      <section className="relative pt-24 pb-12 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-white/20 hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">Available Equipment</h2>
      ...
      {/* Stats Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500/10 to-blue-500/10">
        <div className="max-w-7xl mx-auto">
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-orange-500 to-blue-600 rounded-3xl p-8 text-white">
